...
class AgentRuleRequest(BaseModel):
    """DTO for a single agent rule (internal format)."""
...
class AgentCreateRequest(BaseModel):
    """DTO for creating/updating an agent (internal format)."""
...
class WebBackendAgentRequest(BaseModel):
    """DTO from web backend (matches vision-backend format)."""
